    ...
    return (
        <section className="flex flex-1 flex-col gap-4 p-4 pt-0">
            <Routes>
                ...
                <Route path="errors" element={<Page title="API Error Responses - API Documentation" page={<DocsErrorsPage/>}/>}/>
                <Route path="endpoints" element={<Page title="API Endpoints - API Documentation" page={<DocsEndpointsPage/>}/>}/>
            </Routes>
        </section>
    );
}